        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              {socialSnapchat && (
                <a href={socialSnapchat} target="_blank" rel="noopener noreferrer" aria-label="Snapchat MyJantes" className="w-9 h-9 rounded-full bg-yellow-400/10 flex items-center justify-center text-yellow-400/60 hover:text-yellow-400 hover:bg-yellow-400/20 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                { label: "Espace Client Pro", href: "https://appmyjantes.mytoolsgroup.eu", external: true },
