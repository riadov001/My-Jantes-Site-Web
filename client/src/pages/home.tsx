...
const STATIC_GOOGLE_REVIEWS: GoogleReview[] = [
  ...
  {
    author_name: "Aurore D.",
    rating: 5,
    text: "Rénovation complète de mes 4 jantes en noir mat. Le rendu est absolument parfait. Livraison dans les délais annoncés. Je reviendrai sans hésiter pour mon prochain véhicule !",
    profile_photo_url: "",
    relative_time_description: "il y a 5 jours",
  },
  {
    author_name: "Mickaël R.",
    rating: 5,
    text: "Excellent travail sur mes jantes Mercedes. Peinture brillante impeccable, aucune coulure, les jantes semblent neuves. Prix très compétitif pour cette qualité de prestation.",
    profile_photo_url: "",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 text-center">
            <Button asChild className="bg-auto-red hover:bg-auto-red-dark text-white border-0 font-black px-8 h-12">
              <Link href="/contact#formulaire">Commencer mon devis gratuit <ArrowRight className="ml-2 w-4 h-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-gray-950 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <Button asChild className="bg-auto-red hover:bg-auto-red-dark text-white border-0 font-black px-8 h-12">
              <Link href="/contact#formulaire">Demander un devis gratuit <ArrowRight className="ml-2 w-4 h-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {(googleReviews.length > 0 ? googleReviews.slice(0, 5) : STATIC_GOOGLE_REVIEWS).map((review, i) => (
          ...
          <div className="text-center mt-10">
            <a
              href={c("footer.social_google", "https://share.google/WLKmvaJTSrAFGic2B")}
              target="_blank"
              rel="noopener noreferrer"
              data-testid="link-leave-google-review"
              className="inline-flex items-center gap-2.5 bg-white border border-gray-200 hover:border-green-400 hover:bg-green-50 text-gray-700 hover:text-green-700 font-bold px-6 py-3 rounded-xl shadow-sm hover:shadow-md transition-all text-sm"
            >
