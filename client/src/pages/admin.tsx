    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[
            { label: "Nouveaux devis", value: newContacts, color: "text-blue-600", bg: "bg-blue-50" },
        ...
        {tab === "contacts" && (
          <div className="space-y-3">
            {loadingContacts ? (
              ...
              <Card className="border-0 shadow-sm"><CardContent className="p-12 text-center text-gray-400"><Mail className="w-8 h-8 mx-auto mb-3 opacity-30" /><p>Aucune demande de contact</p><p className="text-xs mt-1">Les demandes envoyées depuis le site ou l'application externe apparaîtront ici.</p></CardContent></Card>
        ...
        {tab === "galerie" && (
          <div>
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-gray-500">{gallery.length} photo(s)</p>
              <Button
                size="sm"
            ...
            {showAddGallery && (
              <Card className="border-0 shadow-md mb-6">
                <CardContent className="p-6">
                  <h3 className="font-bold text-gray-900 mb-4">Nouvelle photo</h3>
                  ...
                  <Button
                    onClick={() => createGallery.mutate(galleryForm)}
                    disabled={!galleryForm.title || !galleryForm.afterImage || createGallery.isPending}
            ...
            {loadingGallery ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                {gallery.map(item => (
                  <Card key={item.id} className="border-0 shadow-sm overflow-hidden group" data-testid={`gallery-card-${item.id}`}>
        ...
        {tab === "avis" && (
          <div>
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-gray-500">{testimonials.length} avis</p>
              <Button
                size="sm"
                className="bg-auto-red hover:bg-auto-red-dark text-white border-0 font-semibold"
            ...
            {showAddTestimonial && (
              <Card className="border-0 shadow-md mb-6">
                <CardContent className="p-6">
                  <h3 className="font-bold text-gray-900 mb-4">Nouvel avis client</h3>
                  ...
                  <Button
                    onClick={() => createTestimonial.mutate(testimonialForm)}
                    disabled={!testimonialForm.name || !testimonialForm.content || createTestimonial.isPending}
                    className="bg-auto-red hover:bg-auto-red-dark text-white border-0"
            ...
            {loadingTestimonials ? (
              ...
              <div className="space-y-3">
                {testimonials.map(t => (
                  <Card key={t.id} className="border-0 shadow-sm" data-testid={`testimonial-card-${t.id}`}>
        ...
        {tab === "faq" && (
          <div>
            ...
            {showAddFaq && (
              <Card className="border-0 shadow-md mb-6">
                <CardContent className="p-6">
                  <h3 className="font-bold text-gray-900 mb-4">Nouvelle question FAQ</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                  ...
                  <Button
                    onClick={() => createFaq.mutate(faqForm)}
                    disabled={!faqForm.question || !faqForm.answer || createFaq.isPending}
                    className="bg-auto-red hover:bg-auto-red-dark text-white border-0"
            ...
            {loadingFaq ? (
              ...
              <div className="space-y-3">
                {faqItems.map(f => (
                  <Card key={f.id} className="border-0 shadow-sm" data-testid={`faq-card-${f.id}`}>
                    <CardContent className="p-5">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-grow">
